...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> confirmOrRejectBooking(Integer bookingId, Boolean approved, Integer userId) {
        return patch("/" + bookingId + "?approved=" + approved, userId);
    }

    public ResponseEntity<Object> getBookingsForOwner(int userId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
